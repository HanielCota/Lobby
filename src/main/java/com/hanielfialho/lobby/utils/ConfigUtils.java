...
@Getter
public class ConfigUtils extends FileConfiguration {
    ...
    public ConfigUtils(Plugin owningPlugin, String name) {
    ...
    @SneakyThrows
    public ConfigUtils(Plugin owningPlugin, String name, String root) {
        if (!name.endsWith(".yml")) name += ".yml";
    ...
    public void load(InputStream stream) throws IOException, InvalidConfigurationException {
        this.configuration.load(stream.toString());
    }
